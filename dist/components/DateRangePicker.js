...
var DateRangePicker = function (_Component) {
  ...
  _createClass(DateRangePicker, [{
    ...
    value: function render() {
      ...
      var focusedRangeIndex = this.state.focusedRange[0];
      return _react2.default.createElement(
        'div',
        { className: (0, _classnames2.default)(this.styles.dateRangePickerWrapper, this.props.className) },
        _react2.default.createElement(_DefinedRange2.default, _extends({}, this.props, {
          range: this.props.ranges[focusedRangeIndex] || {},
          onPreviewChange: function onPreviewChange(value) {
            _this2.dateRange.updatePreview(value);
          },
          focusedRangeIndex: focusedRangeIndex,
          className: undefined
        })),
        _react2.default.createElement(_DateRange2.default, _extends({}, this.props, {
          ref: function ref(t) {
            _this2.dateRange = t;
          },
