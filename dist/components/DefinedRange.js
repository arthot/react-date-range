  ...
  _createClass(DefinedRanges, [{
    ...
    value: function handleRangeChange(range) {
      var _props = this.props,
          ...
          focusedRangeIndex = _props.focusedRangeIndex;

      var selectedRange = ranges[focusedRangeIndex];
      if (!onChange || !selectedRange) return;
      onChange(_defineProperty({}, selectedRange.key || 'range' + (focusedRangeIndex + 1), _extends({}, selectedRange, range)));
    }
  }, {
          ...
          this.props.inputRanges.map(function (rangeOption, i) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement('input', {
                ...
                min: 0,
                max: 99999,
                value: rangeOption.getCurrentValue ? rangeOption.getCurrentValue(ranges[_this2.props.focusedRangeIndex] || {}) : '-'
              }),
              _react2.default.createElement(
                'span',
...
DefinedRanges.propTypes = {
  ...
  focusedRangeIndex: _propTypes2.default.number,
