...
var DayCell = function (_Component) {
  ...
  _createClass(DayCell, [{
    ...
    value: function renderPreviewPlaceholder() {
      ...
      var startDate = preview.startDate ? (0, _end_of_day2.default)(preview.startDate) : null;
      var endDate = preview.endDate ? (0, _start_of_day2.default)(preview.endDate) : null;
      var isInRange = (!startDate || (0, _is_after2.default)(day, startDate)) && (!endDate || (0, _is_before2.default)(day, endDate));
      var isStartEdge = !isInRange && (0, _is_same_day2.default)(day, startDate);
      var isEndEdge = !isInRange && (0, _is_same_day2.default)(day, endDate);
    ...
    value: function renderSelectionPlaceholders() {
      ...
      if (this.props.displayMode === 'date') {
        var isSelected = (0, _is_same_day2.default)(this.props.day, this.props.date);
      ...
      var inRanges = ranges.reduce(function (result, range) {
        var startDate = range.startDate ? (0, _end_of_day2.default)(range.startDate) : null;
        var endDate = range.endDate ? (0, _start_of_day2.default)(range.endDate) : null;
        var isInRange = (!startDate || (0, _is_after2.default)(day, startDate)) && (!endDate || (0, _is_before2.default)(day, endDate));
        var isStartEdge = !isInRange && (0, _is_same_day2.default)(day, startDate);
        var isEndEdge = !isInRange && (0, _is_same_day2.default)(day, endDate);
...
DayCell.propTypes = {
  ...
  isSunday: _propTypes2.default.bool,
